...
#     network = tflearn.embedding(network, input_dim=max_sequence+1, output_dim=128)
    ...
    print 'branch11:'
    branch11 = conv_1d(network, 128, 3, padding='valid', activation='relu')
    print branch11
    print 'branch12:'
    branch12 = conv_1d(network, 128, 4, padding='valid', activation='relu')
    print branch12
    branch13 = conv_1d(network, 128, 5, padding='valid', activation='relu')
    print branch13
    ...
    branch21 = conv_1d(branch11, 128, 3, padding='valid', activation='relu')
    print branch21
    branch22 = conv_1d(branch12, 128, 4, padding='valid', activation='relu')
    print branch22
#     branch23 = conv_1d(branch13, 128, 5, padding='valid', activation='relu', regularizer="L2")
    branch23 = conv_1d(branch13, 128, 5, padding='valid', activation='relu')
    print branch23
    ...
    network = regression(network, optimizer='Adam', learning_rate=0,
